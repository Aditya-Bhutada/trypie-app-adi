...
import { createGroup, joinGroup, acceptGroupInvitation } from "@/services/travel-group-service";
...
const Groups = () => {
  ...
  useEffect(() => {
    ...
    if (inviteToken && isAuthenticated && !processingInvitation) {
      const processInvitation = async () => {
        setProcessingInvitation(true);
        
        try {
          const result = await acceptGroupInvitation(inviteToken);
  ...
  }, [searchParams, isAuthenticated, toast, navigate, refreshAllGroups, loadMyGroups]);
