...
const Profile = () => {
  ...
  const emailForm = useForm<z.infer<typeof emailFormSchema>>({
    ...
    defaultValues: {
      email: "",  // changed from user?.email to empty string as per request
      password: "",
    },
  });
                ...
                <Card className="subtle-shadow mb-6">
                  ...
                  <CardContent>
                    <div className="email-update-section">
                      <h2 className="text-lg font-semibold mb-2">Update Email Address</h2>
                      <p className="text-gray-700 mb-1 flex gap-2 items-center">
                        <span className="font-medium">Current email:</span>
                        <span className="bg-gray-100 px-2 py-1 rounded text-gray-800">{user?.email}</span>
                      </p>
                      <Form {...emailForm}>
                        <form onSubmit={emailForm.handleSubmit(handleEmailUpdate)} className="space-y-4">
                          <div>
                            ...
                            <input
                              ...
                              className="mt-1 shadow-sm block w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-trypie-600 focus:border-trypie-600"
                            />
                          </div>
                          <FormField
