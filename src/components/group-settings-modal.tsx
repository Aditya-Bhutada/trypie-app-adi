...
const GroupSettingsModal = ({
  ...
  const handleInviteMember = async () => {
    ...
    try {
      const response = await inviteUserToGroup(group.id, inviteEmail);
  ...
  const generateInviteLink = async () => {
    ...
    try {
      ...
      const placeholderEmail = `link-${token}@trypie.app`;
      ...
      const newInviteLink = `${baseUrl}/groups/invitation?token=${token}`;
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="border-t pt-4">
                  <h4 className="font-medium mb-2 flex items-center gap-2">
                    <LinkIcon className="h-4 w-4 text-trypie-600" />
                    Invitation Link
                  </h4>
                  ...
                  {linkGenerated ? (
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center">
                        <p className="text-xs text-amber-600">This link will remain active for 30 days</p>
                        <Button 
                          variant="ghost" 
                          size="sm" 
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-md p-3">
                  <p className="text-sm text-amber-800">
                    <span className="font-medium">Share the invitation link</span> with multiple people. Each person can use the same link to join your group.
                  </p>
                </div>
              </div>
            </div>
