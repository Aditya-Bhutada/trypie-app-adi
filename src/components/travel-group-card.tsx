...
import { getDestinationImage } from "@/services/travel-group-service";
...
const TravelGroupCard = ({
  ...
  // Get appropriate destination image - use provided image_url if available, otherwise generate based on destination
  const cardImageUrl = image_url || getDestinationImage(destination);
